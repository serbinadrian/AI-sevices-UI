...
import { Poetic } from "./poetic_pb_service";
import { useStyles } from "./styles";
import { withStyles } from "@material-ui/styles";

class PoeticTextGeneration extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      users_guide: "https://github.com/iktina/poetic-text-generation",
      code_repo: "https://github.com/iktina/poetic-text-generation",
      reference: "https://github.com/iktina/poetic-text-generation",
      text_content: "",
      temperature: 0.85,
      top_k: 50,
      length: 512,
  ...
  submitAction() {
    ...
    const methodDescriptor = Poetic["generate"];
...
export default withStyles(useStyles)(PoeticTextGeneration);