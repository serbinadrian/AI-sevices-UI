...
export default class NeuralAbstractiveSummarisation extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      users_guide: "https://github.com/iktina/neural-abstractive-summarization",
      code_repo: "https://github.com/iktina/neural-abstractive-summarization",
      reference: "https://github.com/iktina/neural-abstractive-summarization",
      text_content: "",
      maxTextLength: 1000
    };
  }
  ...
  submitAction() {
    ...
    const methodDescriptor = neural_summarisation["neural_summarisation"];
    ...
    const props = {
      ...
      onEnd: ({ message }) => {
        this.setState({
          response: { status: "success", text_summary: message.getSummary() },
        });
      },
    };
