...
class NeuralAbstractiveSummarisation extends React.Component {
  ...
  submitAction() {
    ...
    const methodDescriptor = neural_summarisation[service.METHOD];
...
export default withStyles(useStyles)(NeuralAbstractiveSummarisation);
