export const MODEL = {
  informationLinks: {
    GIT_HUB: "https://github.com/iktina/neural-paraphrase-generation",
    USER_GUIDE: "https://github.com/iktina/neural-paraphrase-generation",
    ORIGINAL_PROJECT: "https://github.com/iktina/neural-paraphrase-generation",
  },
  state: {
    response: undefined,
    textInputValue: "",
...
export const LABELS = {
  ...
  errors: {
    ONLY_LATINS_REGEX_ERROR: `The input text must be written in English only! No more than ${rangeRestrictions.ONLY_LATINS_TEXT_LENGTH.max} characters. More than ${rangeRestrictions.MINIMUM_WORDS} word`,
  },
};
