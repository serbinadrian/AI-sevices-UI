...
import { TER } from "./ter_pb_service";

export default class TextualEmotionsRecognition extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      users_guide: "https://github.com/iktina/textual-emotion-recognition",
      code_repo: "https://github.com/iktina/textual-emotion-recognition",
      reference: "https://github.com/iktina/textual-emotion-recognition",
      text_content: "",
      maxTextLength: 1000
    };
  }
  ...
  submitAction() {
    ...
    const methodDescriptor = TER["recognize"];
    const request = new methodDescriptor.requestType();

    request.setText(this.constructRequest(text_content));
    const props = {
      request,
      onEnd: ({ message }) => {
        this.setState({
      ...
      <div style={{ background: "#F8F8F8", padding: "24px" }}>
        ...
        <div style={{ padding: "10px 10px 0 10px", fontSize: "14px", color: "#9b9b9b" }}>
          <div style={{ padding: "10px 0" }}>
            ...
            >
              Recognized emotion is <b>{response.output.emotion}</b>
            </div>
          </div>
        </div>
      </div>
