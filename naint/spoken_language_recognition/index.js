...
import { SLR } from "./SLR_pb_service";
...
export default class SpokenLanguageRecognition extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...initialUserInput,
      users_guide: "https://github.com/iktina/spoken-language-recognition",
      code_repo: "https://github.com/iktina/spoken-language-recognition",
      reference: "https://github.com/iktina/spoken-language-recognition",
      response: undefined,
      data: undefined
    };
  }
  ...
  submitAction() {
    ...
    const methodDescriptor = SLR["sl2l"];
    ...
    const props = {
      ...
      onEnd: response => {
        ...
        this.setState({
          ...initialUserInput,
          response: { status: "success", text: message.getLabel() },
        });
      },
    };
      ...
      <div style={{ background: "#F8F8F8", padding: "24px" }}>
        ...
        <div style={{ padding: "10px 10px 0 10px", fontSize: "14px", color: "#9b9b9b" }}>
          <div style={{ padding: "10px 0" }}>
            ...
            >
              Recognized language is <b>{this.state.response.text}</b>
            </div>
          </div>
        </div>
      </div>
