    ...
    configuration: {
        state: {
            ...
            informationLinks: {
                ...
                userGuide: "https://github.com/iktina/question-answering-long-seq-service",
                originalProject: "https://github.com/iktina/question-answering-long-seq-service",
            },
        },
        restrictions: {
            wordsMinimumCount: 3,
        ...
        blocks: {
            input: {
                question:{
                    ...
                    rows: 3,
                    edit: true,
                    labelKey: "serviceInput",
                    stateKey: "question",
                    handleKey: "handleTextInput",
                    helperKey: "inputHelperTextFunction"
                }
            },
            output: {
                userInput: {
