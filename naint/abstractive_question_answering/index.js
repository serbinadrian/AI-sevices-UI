...
export default class AbstractiveQuestionAnswering extends React.Component {
  constructor(props) {
    super(props);
  ...
  canBeInvoked() {
    return this.state.regex.exec(this.state.question);
  }
        ...
        <Grid container direction="column" justify="center">
          <Grid item xs={12} style={{ textAlign: "left" }}>
            <OutlinedTextArea
              ...
              helperTxt={this.state.wordsCount + " / " + this.state.wordsLimit + " words"}
