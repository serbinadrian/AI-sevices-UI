...
import { ofa_caption } from "./image_caption_pb_service";

export default class ImageCaptioning extends React.Component {
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            users_guide: "https://github.com/iktina/image-captioning",
            code_repo: "https://github.com/iktina/image-captioning",
            reference: "https://github.com/iktina/image-captioning",
    ...
    submitAction() {
        const methodDescriptor = ofa_caption["Caption"];
        const request = new methodDescriptor.requestType();

        request.setImage(this.state.image.data);
        ...
        const props = {
            ...
            onEnd: response => {
                ...
                this.setState({
                    response: { result: message.getCaption() },
                });
            },
        };
