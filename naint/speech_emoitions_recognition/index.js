...
import { emotions } from "./emotions_pb_service";
...
export default class SpeechEmotionRecognition extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...initialUserInput,
      users_guide: "https://github.com/iktina/speech-emotion-recognition",
      code_repo: "https://github.com/iktina/speech-emotion-recognition",
      reference: "https://github.com/iktina/speech-emotion-recognition",
      response: undefined,
      data: undefined
    };
  }
  ...
  submitAction() {
    ...
    const methodDescriptor = emotions["e2t"];
      ...
      <div style={{ background: "#F8F8F8", padding: "24px" }}>
        ...
        <div style={{ padding: "10px 10px 0 10px", fontSize: "14px", color: "#9b9b9b" }}>
          <div style={{ padding: "10px 0" }}>
            ...
            >
              Recognized emotion is <b>{this.state.response.text}</b>
            </div>
          </div>
        </div>
      </div>
