...
import { MST } from "./MST_pb_service";
...
export default class MultilingualSpeechTranslation extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...initialUserInput,
      users_guide: "https://github.com/iktina/multilingual-speech-translation",
      code_repo: "https://github.com/iktina/multilingual-speech-translation",
      reference: "https://github.com/iktina/multilingual-speech-translation",
      response: undefined,
      data: undefined
    };
  }
  ...
  submitAction() {
    ...
    const methodDescriptor = MST["s2t"];
