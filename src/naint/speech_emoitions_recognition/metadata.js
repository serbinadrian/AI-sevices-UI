export const MODEL = {
  informationLinks: {
    GIT_HUB: "https://github.com/iktina/speech-emotion-recognition",
    USER_GUIDE: "https://github.com/iktina/speech-emotion-recognition",
    ORIGINAL_PROJECT: "https://github.com/iktina/speech-emotion-recognition",
  },
  state: {
    response: undefined,
...
export const LABELS = {
  labels: {
    SERVICE_OUTPUT: "Recognized emotion is",
