...
import { emotions } from "./speech_emotion_recognition_pb_service";
...
class SpeechEmotionsRecognition extends React.Component {
  constructor(props) {
    super(props);
    const { state } = MODEL;
  ...
  submitAction() {
    ...
    const methodDescriptor = emotions[METHOD];
...
export default withStyles(useStyles)(SpeechEmotionsRecognition);
