...
import { MST } from "./multilingual_speech_translation_pb_service";
...
class MultilingualSpeechTranslation extends React.Component {
  constructor(props) {
    super(props);
    const { state } = MODEL;
  ...
  submitAction() {
    ...
    const methodDescriptor = MST[METHOD];
...
export default withStyles(useStyles)(MultilingualSpeechTranslation);
