...
import { Lyrics } from "./lyrics_pb_service";
import { useStyles } from "./styles";
import { withStyles } from "@material-ui/styles";

class MusicLyricsGeneration extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      users_guide: "https://github.com/iktina/Music-Lyrics-Generation",
      code_repo: "https://github.com/iktina/Music-Lyrics-Generation",
      reference: "https://github.com/iktina/Music-Lyrics-Generation",
      text_content: "",
      temperature: 0.85,
      top_k: 10,
      length: 512,
  ...
  submitAction() {
    ...
    const methodDescriptor = Lyrics["generate"];
...
export default withStyles(useStyles)(MusicLyricsGeneration);