...
import { VAD } from "./vad_pb_service";
...
class VoiceActivityDetection extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...initialUserInput,
      users_guide: "https://github.com/iktina/voice-activity-detection",
      code_repo: "https://github.com/iktina/voice-activity-detection",
      reference: "https://github.com/iktina/voice-activity-detection",
      response: undefined,
      data: undefined
    };
  }
  ...
  submitAction() {
    ...
    const methodDescriptor = VAD["speech_slicing"];
    const request = new methodDescriptor.requestType();

    request.setData(data);
    request.setTrashold(timeFrame.toString());
    ...
    const props = {
      ...
      onEnd: response => {
        ...
        this.setState({
          ...initialUserInput,
          response: { status: "success", data: message.getLink() },
        });
      },
    };
        ...
        <Grid container direction="column" justify="center" spacing={2}>
          ...
          <Grid item xs={12} sm={12} md={12} lg={12} className={classes.progressBarContainer}>
            <Grid item xs={12} sm={12} md={3} lg={3}>
              ...
              <span className={classes.title}>Threshold</span>
            </Grid>
            ...
            <Grid item xs={12} sm={12} md={9} lg={9} className={classes.sliderContainer}>
              ...
              />
              <span className={classes.startEndNumber}>10</span>
            </Grid>
          </Grid>
      ...
      <div style={{ background: "#F8F8F8", padding: "24px" }}>
        ...
        <div style={{ padding: "10px 10px 0 10px", fontSize: "16px", color: "#9b9b9b" }}>
          <div style={{ padding: "10px 0", fontSize: "16px" }}>
            Use the following link to get results: <a href={response.data} download>click here to download</a>
          </div>
        </div>
      </div>
    );
...
export default withStyles(useStyles)(VoiceActivityDetection);