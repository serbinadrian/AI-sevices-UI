...
import { SCR } from "./speech_commands_recognition_pb_service";
...
class SpeechCommandsRecognition extends React.Component {
  constructor(props) {
    super(props);
    const { state } = MODEL;
  ...
  submitAction() {
    ...
    const methodDescriptor = SCR[METHOD];
...
export default withStyles(useStyles)(SpeechCommandsRecognition);
