export const MODEL = {
  informationLinks: {
    GIT_HUB: "https://github.com/iktina/speech-commands-recognition",
    USER_GUIDE: "https://github.com/iktina/speech-commands-recognition",
    ORIGINAL_PROJECT: "https://github.com/iktina/speech-commands-recognition",
  },
  state: {
    response: undefined,
...
export const LABELS = {
  labels: {
    SERVICE_OUTPUT: "Recognized command is",
