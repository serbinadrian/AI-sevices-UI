...
import { handwrittenOCR } from "./htr_pb_service";

export default class HandwrittenTextRecognition extends React.Component {
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            users_guide: "https://github.com/iktina/handwritten-text-recognition-service",
            code_repo: "https://github.com/iktina/handwritten-text-recognition-service",
            reference: "https://github.com/iktina/handwritten-text-recognition-service",
    ...
    submitAction() {
        const methodDescriptor = handwrittenOCR["handwrittenOCR"];
